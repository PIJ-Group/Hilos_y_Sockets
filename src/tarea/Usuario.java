...
/*Cliente de la aplicación, llamado Usuario, que contendrá el menú para interactuar con el servidor y la creación de su Socket.*/
...
public class Usuario {
	...
	public static void main(String[] args) {
		...
		//Utilizamos un bloque TRY para crear el Socket, sus streams, y la lógica del cliente para cerrarse a la vez que el hilo o devolver los datos del menú.
		try{
			...
			/*Utilización de un bloque DO_WHILE para la lógica del menú.
			  Escogemos este tipo de bucle para que siempre salga el menú excepto en el caso de querer salir de él*/
			do {
		        ...
		        //Bloque IF, en el cual si el servidor (concretamente la clase Hilo) devuelve 5, cambiamos la condición y salimos del bucle.
